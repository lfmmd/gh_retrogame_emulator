...
public class GenericEventMapper implements EventMapper {
	...
	private static int KEY_0;
	private static int KEY_1;
	private static int KEY_2;
	private static int KEY_3;
	private static int KEY_4;
	private static int KEY_5;
	private static int KEY_6;
	private static int KEY_7;
	private static int KEY_8;
	private static int KEY_9;
	...
	public static void updateKeyMap() {
		...
		KEY_0 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_0", KeyConstants.VK_0);
		KEY_1 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_1", KeyConstants.VK_1);
		KEY_2 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_2", KeyConstants.VK_2);
		KEY_3 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_3", KeyConstants.VK_3);
		KEY_4 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_4", KeyConstants.VK_4);
		KEY_5 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_5", KeyConstants.VK_5);
		KEY_6 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_6", KeyConstants.VK_6);
		KEY_7 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_7", KeyConstants.VK_7);
		KEY_8 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_8", KeyConstants.VK_8);
		KEY_9 = Configuration.getIntProperty("org.thenesis.midpath.ui.keys.NUM_9", KeyConstants.VK_9);
	}
